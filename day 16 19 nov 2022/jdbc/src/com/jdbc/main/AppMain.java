...
public class AppMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("to add order type ADD");
		System.out.println("to delete an exiting order type DEL");
		System.out.println("to update an existing order type UPDATE");
		System.out.println("to get all orders type GET");
		System.out.println("to search an order type SEARCH");
		String op = sc.next();
